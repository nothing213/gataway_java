...
//        JSONObject[] jsonObj = new JSONObject[openApiData.size()];
    ...
    public CommonResult<OpenApiGroup> findAllApi() {
        List<OpenApiGroup> openApiData = apiService.findAllApi();
    ...
    public CommonResult<OpenApiGroup> deleteApi(@RequestBody OpenApiData openApiData) {
...
//    String startTime = df.format(day);
